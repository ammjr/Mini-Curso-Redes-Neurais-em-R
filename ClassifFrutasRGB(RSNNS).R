...
# Dataset disponível em: https://www.kaggle.com/moltean/fruits
# =============================================================
...
diret_base <- 'C:/Users/jrjpm/Desktop/Cursos Ministrados/RNA v2.0/Datasets/Fruits/Fruites_reduce'

# Listagem das subpastas que estão no diretório base
list_diret <- list.dirs(diret_base, recursive = FALSE)
dim_image <- 3 # Tipo das imagens (que se deseja trabalhar) (2 p/ PB e 3 p/ colorida)
...
# Plota uma das imagens como exemplo
plot(arquivos[[1]])
...
# Plota curva ROC com AUC (caso duas classes)
library(pROC)
par(pty='s')
...
endereco <- 'C:/Users/jrjpm/Desktop/Cursos Ministrados/RNA v2.0/Datasets/Fruits/Teste/Banana/99_100.jpg'
endereco <- 'C:/Users/jrjpm/Desktop/Cursos Ministrados/RNA v2.0/Datasets/Fruits/Teste/Pepper Red/150_100.jpg'
endereco <- 'C:/Users/jrjpm/Desktop/Cursos Ministrados/RNA v2.0/Datasets/Fruits/Teste/Avocado/6_100.jpg'
...
image_teste <- endereco  %>% lapply(load.image) %>% 
   lapply(resize, size_x = 22, size_y = 22)
...
# Colocar *1 para imagens em PeB e *3 para imagens colorids 
# (3 canais de cores, tem o triplo de variáveis)
dados_image_teste <- matrix(nrow = qtde_amostras_image_teste, ncol= qtde_var_image_teste*3)
...
# Predição da classe a qual a imagem pertence
